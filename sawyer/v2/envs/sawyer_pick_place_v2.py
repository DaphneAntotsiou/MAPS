'''
This script is heavily based on @metaworld/envs.mujoco.sawyer_xyz.v2.sawyer_pick_place_v2.
It resets all observations during reset and extends it with a setter of state
'''
import numpy as np
...
from sawyer.v2.envs.sawyer_xyz_env import SawyerXYZEnv
