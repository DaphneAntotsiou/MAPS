'''
This script is heavily based on @metaworld/envs.mujoco.sawyer_xyz.v2.sawyer_door_v2.
...
class SawyerDoorEnvV2(SawyerXYZEnv):
    ...
    def compute_reward(self, actions, obs):
        theta = get_joint_qpos(self.sim, 'doorjoint')
        #self.data.get_joint_qpos('doorjoint')
